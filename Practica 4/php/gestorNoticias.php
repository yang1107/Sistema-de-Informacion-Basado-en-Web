...
class GestorNoticias{
   ...
   function getNoticiasPortada(){
         ...
         $result=$conexion->query("select id from noticias where seccion='futbol' order BY RAND()");
         $result2=$conexion->query("select id from noticias where seccion='baloncesto'order BY RAND()");
         $result3=$conexion->query("select id from noticias where seccion='motor'order BY RAND()");
